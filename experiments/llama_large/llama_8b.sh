...
# NOTE: CUDA illegal memory access
cd /workspace/git/fsdp_qlora && python train.py \
--resume_from_dora_weights /workspace/models/llama-3-1-8b-instruct-dora-4-2bit-lora_rank-256-base_lr-5e-5-lr_div_factor-10-train_layernorms-true-block-influence-adj-30pct/step_125/model_state_dict.safetensors \
--resume_from_optimizer /workspace/models/llama-3-1-8b-instruct-dora-4-2bit-lora_rank-256-base_lr-5e-5-lr_div_factor-10-train_layernorms-true-block-influence-adj-30pct/step_125/optimizer.bin \
--train_type hqq_dora \
--nbits mixed \
--groupsize_2bit 32 \
