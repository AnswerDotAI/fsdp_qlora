...
class DORA(nn.Module):
    """
    FSDP compatible DORA module, supporting HQQ, BnB and torch nn.Linear.
    """
    ...
    def forward(self, x, *args, **kwargs):
        ...
        if isinstance(self.base_layer, HQQLinear):
            output, column_norm = self.dora_layer(x, self.base_layer.dequantize())
        elif isinstance(self.base_layer, Linear4bit):
            ...
            output, column_norm = self.dora_layer(x, self.base_layer.weight.data)
